...
function WebGLSetup(id) {
  ...
  const tmp = [ geometry.faces[10], geometry.faces[11] ]
  geometry.faces[10] = geometry.faces[0]
  geometry.faces[11] = geometry.faces[1]
  geometry.faces[0] = tmp[0]
  geometry.faces[1] = tmp[1]
